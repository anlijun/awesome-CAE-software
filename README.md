...
| [Python TetGen](https://github.com/pyvista/tetgen) | Python/C++ | Open Source | A Python interface to the C++ [TetGen](https://github.com/ufz/tetgen) library to generate tetrahedral meshes of any 3D polyhedral domains. |
